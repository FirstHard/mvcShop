          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-8">
              <ul class="nav justify-content-center text-light pb-3 mb-3">
                ...
                <li class="nav-item"><a href="/shop" class="nav-link px-2">Shop</a></li>
                <li class="nav-item"><a href="/product/view/3" class="nav-link px-2">Demo product</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2">Cart</a></li>
                <li class="nav-item"><a href="/user/login" class="nav-link px-2">Login</a></li>
              </ul>
